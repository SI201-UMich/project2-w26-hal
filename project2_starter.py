...
# Your name: Hally Levine 
# Your student id: 7678 3278
# Your email: hally@umich.edu
# Who or what you worked with on this homework (including generative AI like ChatGPT):
# If you worked with generative AI also add a statement for how you used it.
# e.g.:
# Asked ChatGPT for hints on debugging and for suggestions on overall code structure
# Yes, I used GenAI to help me debug my code on sections where I got stuck. 
# Did your use of GenAI on this assignment align with your goals and guidelines in your Gen AI contract? If not, why?
# Yes, my use of GenAI on this assignmet aligns with my goals and guidlines of my contract. 
...
def load_listing_results(html_path) -> list[tuple]:
    ...
    for a in soup.find_all("a", href=True):
        ...
        # Find the listing card title closest to this link
        card = a.find_parent(attrs={"data-testid": "card-container"})
        if not card:
            continue
...
def output_csv(data, filename) -> None:
    ...
    # YOUR CODE STARTS HERE
    # ==============================
    sorted_location = sorted(data, key=lambda x: x[6], reverse = True)
    ...
    pass
    #COME BACK TO THIS CODE AND TEST IT
    # ==============================
    # YOUR CODE ENDS HERE
    # ==============================
...
class TestCases(unittest.TestCase):
    ...
    def test_get_listing_details(self):
        ...
        for listing_id in html_list:
            list_of_details.append(get_listing_details(listing_id))

        # TODO: Spot-check a few known values by opening the corresponding listing_<id>.html files.
        # 1) Check that listing 467507 has the correct policy number "STR-0005349". 
        self.assertEqual(list_of_details[0]["467507"]["policy_number"], "STR-0005349")
        # 2) Check that listing 1944564 has the correct host type "Superhost" and room type "Entire Room".
        self.assertEqual(list_of_details[2]["1944564"]["host_type"], "Superhost")
        self.assertEqual(list_of_details[2]["1944564"]["room_type"], "Entire Room")
        # 3) Check that listing 1944564 has the correct location rating 4.9.
        self.assertEqual(list_of_details[2]["1944564"]["location_rating"], 4.9)
        pass
    ...
    def test_validate_policy_numbers(self):
        ...
        invalid_ids = validate_policy_numbers(self.detailed_data)
        # TODO: Check that the list contains exactly "16204265" for this dataset.
        self.assertEqual(invalid_ids, ["16204265"])
        pass
